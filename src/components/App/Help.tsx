    ...
    return (
        <>
            <div className="fixed inset-0 flex justify-center items-center bg-background backdrop-blur-sm z-101">
                <div
                    className="w-72 h-56 bg-background/90 border border-zinc-700 rounded-2xl shadow-2xl p-6 flex flex-col items-center gap-5">
                    <div>
                ...
                <button
                    onClick={() => onClose()}
                    className="inline-flex bottom-0 absolute mb-28 cursor-pointer hover:font-bold"
                >
